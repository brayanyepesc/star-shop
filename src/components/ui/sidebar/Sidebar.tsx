      ...
      <nav className={
        ...
        <div className="relative mt-14">
          ...
          <input 
            type="text" 
            placeholder="Search"
            className="w-full bg-gray-50 rounded pl-10 py-1 pr-10 border-b-2 text-xl border-gray-200 focus:outline-none focus:border-violet-500"
          />
        </div>
        <Link 
          href='/'
        ...
        >
          <IoTicketOutline 
            size={30}
          />
          <span className="ml-3 text-xl">System Orders</span>
        </Link>
        <Link 
          href='/'
          className="flex items-center mt-10 p-2 hover:bg-gray-100 rounded transition-all"
