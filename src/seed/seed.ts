...
export const initialData: SeedData = {
    ...
    products: [
        ...
        {
            description: "Designed for fit, comfort and style, the kidss Cybertruck Graffiti Long Sleeve Tee features a water-based Cybertruck graffiti wordmark across the chest, a Tesla wordmark down the left arm and our signature T logo on the back collar. Made from 50% cotton and 50% polyester.",
            images: [
        ...
        {
            description: "The kidss Scribble T Logo Tee is made from 100% Peruvian cotton and features a Tesla T sketched logo for every young artist to wear.",
            images: [
        ...
        {
            description: "The kidss Cybertruck Tee features the iconic Cybertruck graffiti wordmark and is made from 100% Peruvian cotton for maximum comfort.",
            images: [
        ...
        {
            description: "The refreshed kidss Racing Stripe Tee is made from 100% Peruvian cotton, featuring a newly enhanced racing stripe with a brushed Tesla wordmark that's perfect for any speed racer.",
            images: [
        ...
        {
            description: "The kidss Scribble T Logo Onesie is made from 100% Peruvian cotton and features a Tesla T sketched logo for every little artist to wear.",
            images: [
        ...
        {
            description: "Cruise the playground in style with the kidss Corp Jacket. Modeled after the original Tesla Corp Jacket, the kidss Corp Jacket features the same understated style and high-quality materials but at a pint-sized scale.",
            images: [
